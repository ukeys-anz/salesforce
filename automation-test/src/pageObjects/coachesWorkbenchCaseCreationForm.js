...
var _CoachesWorkbenchCaseCreationFormPicklist = require("./../pageObjects/coachesWorkbenchCaseCreationFormPicklist");
...
class CoachesWorkbenchCaseCreationForm extends core.UtamBaseRootPageObject {
  ...
  async getPicklistItemsLists() {
    ...
    elements = elements.map(function _createElement(element) {
      return new _CoachesWorkbenchCaseCreationFormPicklist__default[
        "default"
      ](driver, element);
    });
...
module.exports = CoachesWorkbenchCaseCreationForm;
