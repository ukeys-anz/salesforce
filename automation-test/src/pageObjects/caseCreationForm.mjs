...
import _CaseCreationFormPicklist from "./../pageObjects/caseCreationFormPicklist";
...
export default class CaseCreationForm extends _UtamBaseRootPageObject {
  ...
  async getPicklistItemsLists() {
    ...
    elements = elements.map(function _createElement(element) {
      return new _CaseCreationFormPicklist(driver, element);
    });
