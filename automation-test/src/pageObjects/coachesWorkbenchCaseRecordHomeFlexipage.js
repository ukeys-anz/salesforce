...
class CoachesWorkbenchCaseRecordHomeFlexipage extends core.UtamBaseRootPageObject {
  constructor(
    driver,
    element,
    locator = core.By.css(
  ...
  async getMainRegionActiveTabDetailPanel() {
    const _statement0 = await this.getCaseRecordPage();
    ...
    const _result3 = await _statement2.getContent(
      _LwcDetailPanel__default["default"]
    );
    return _result3;
  }
}

module.exports = CoachesWorkbenchCaseRecordHomeFlexipage;
