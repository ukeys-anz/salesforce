...
async function _utam_get_email(driver, root) {
  let _element = root;
  const _locator = core.By.css(`[name='loginfmt']`);
  return _element.findElement(_locator);
}

async function _utam_get_next(driver, root) {
  let _element = root;
  const _locator = core.By.css(`input[type='submit']`);
  return _element.findElement(_locator);
}

async function _utam_get_password(driver, root) {
  let _element = root;
  const _locator = core.By.css(`[name='passwd']`);
  return _element.findElement(_locator);
}

class TwilioLogin extends core.UtamBaseRootPageObject {
