...
async function _utam_get_inputRadio(driver, root) {
  let _element = root;
  const _locator = _By.css(`input[type='radio']`);
  _element = new _ShadowRoot(driver, _element);
  return _element.findElement(_locator);
}
...
async function _utam_get_error(driver, root) {
  let _element = root;
  const _locator = _By.css(`.slds-form-element__help`);
  _element = new _ShadowRoot(driver, _element);
  return _element.findElement(_locator);
}
...
async function _utam_get_datepicker(driver, root) {
  let _element = root;
  const _locator = _By.css(`lightning-datepicker`);
  _element = new _ShadowRoot(driver, _element);
...
export default class Input extends _UtamBasePageObject {
  ...
  async getDatepicker() {
    ...
    element = new _Datepicker(driver, element);
  ...
  async hasLabel() {
    ...
    const _result0 = await _statement0.containsElement(_By.css(`label`), true);
    return _result0;
  }
  ...
  async hasDatetimepicker() {
    ...
    const _result0 = await _statement0.containsElement(
      _By.css(`lightning-datetimepicker`),
      true
    );
    return _result0;
  }
