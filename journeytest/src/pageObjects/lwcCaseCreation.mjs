...
async function _utam_get_newCase(driver, root) {
  let _element = root;
  const _locator = _By.css(`a div[title='New']`);
  return _element.findElement(_locator);
}

async function _utam_get_selectElementss(driver, root) {
  let _element = root;
  const _locator = _By.css(`div a[class='select']`);
...
async function _utam_get_nextButton(driver, root) {
  let _element = root;
  const _locator = _By.css(`footer button:nth-of-type(2)`);
  return _element.findElement(_locator);
}

async function _utam_get_channelReceived(driver, root) {
  let _element = root;
  const _locator = _By.css(`a[class='select']:nth-of-type(2)`);
  return _element.findElement(_locator);
}

async function _utam_get_tabItem(driver, root, index) {
  let _element = root;
  const _locator = _By.css(`li[class='tabItem'] button:nth-of-type(${index})`);
  return _element.findElement(_locator);
}

async function _utam_get_customerDropDown(driver, root, customerName) {
  let _element = root;
  const _locator = _By.css(`li div[title='${customerName}']`);
  return _element.findElement(_locator);
}

async function _utam_get_valueDropDown(driver, root, itemValue) {
  let _element = root;
  const _locator = _By.css(`li a[title='${itemValue}']`);
  return _element.findElement(_locator);
}

async function _utam_get_dualListLeft(driver, root, itemValue) {
  let _element = root;
  const _locator = _By.css(`div span[title='${itemValue}']`);
  return _element.findElement(_locator);
}

async function _utam_get_dualListLeftItemss(driver, root) {
  let _element = root;
  const _locator = _By.css(`li[lightning-duallistbox_duallistbox]`);
  return _element.findElements(_locator);
}

async function _utam_get_moveChosen(driver, root) {
  let _element = root;
  const _locator = _By.css(`button[title='Move selection to Chosen']`);
  return _element.findElement(_locator);
}

async function _utam_get_saveCase(driver, root) {
  let _element = root;
  const _locator = _By.css(`button[title='Save']`);
  return _element.findElement(_locator);
}

async function _utam_get_customerInput(driver, root) {
  let _element = root;
  const _locator = _By.css(`input[title='Search Accounts']`);
  return _element.findElement(_locator);
}
