...
export default class GenericField extends NavigationMixin(LightningElement) {
  ...
  get _dataValueBlank() {
    let _compVal = this.field.stringify
      ? JSON.stringify(this.value)
      : this.value;
    if (_compVal && Boolean(_compVal)) {
      return false;
    }
    return true;
  }
  ...
  get isNumber() {
    if (
      this.field &&
      Object.hasOwn(this.field, "fieldtype") &&
  ...
  get isCurrency() {
    if (
      this.field.attributes &&
      Object.hasOwn(this.field.attributes, "format-style")
    ) {
      return this._attributes["format-style"] === "currency";
    }
    return false;
  }
  get isEmail() {
