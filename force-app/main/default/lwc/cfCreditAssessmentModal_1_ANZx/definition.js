let definition = {
              ...
              children: [
                {
                  ...
                  styleObject: {
                    ...
                    class: "slds-theme_default slds-p-around_small ",
                    sizeClass: "slds-size_12-of-12 ",
                    margin: [],
                    background: {
                      color: "#014486",
                  ...
                  children: [
                    {
                      ...
                      property: {
                        ...
                        type: "text",
                        card: "{card}",
                        label: "Select a referral outcome",
                        styles: {
                          label: {
                            fontSize: "24px",
                            color: "#FFFFFF",
                ...
                },
                {
                  ...
                  styleObject: {
                    ...
                    class: "slds-p-top_small slds-p-left_small ",
                    sizeClass: "slds-size_12-of-12 ",
                    margin: [],
                    background: {
                      color: "",
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      property: {
                        ...
                        card: "{card}",
                        label: "Guidance",
                        fieldLevelHelp: "Something about guidance"
                      },
                      type: "element",
                      styleObject: {
                        sizeClass: "slds-size_2-of-12 ",
                  ...
                  children: [
                    {
                      ...
                      property: {
                        record: "{record}",
                        mergeField: "%3Cdiv%3E%7BreasonCode%7D%3C/div%3E",
                        card: "{card}"
                      },
                      type: "text",
                      styleObject: {
                    ...
                    },
                    {
                      ...
                      property: {
                        record: "{record}",
                        mergeField:
                          "%3Cdiv%3E%7BassessmentCategory%7D%3C/div%3E",
                        card: "{card}"
                      },
                      type: "text",
                      styleObject: {
                    ...
                    },
                    {
                      ...
                      property: {
                        record: "{record}",
                        mergeField:
                          "%3Cdiv%3E%7BreasonDescription%7D%3C/div%3E",
                        card: "{card}"
                      },
                      type: "text",
                      styleObject: {
                    ...
                    },
                    {
                      ...
                      property: {
                        record: "{record}",
                        mergeField: "%3Cdiv%3E%7BguidanceCode%7D%3C/div%3E",
                        card: "{card}"
                      },
                      type: "text",
                      styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    ...
                    propertyObj: {
                      ...
                      type: "combobox",
                      fieldLevelHelp: "",
                      placeholder: "Select one referral outcome",
                      value: "",
                      options: [],
                      customProperties: [],
                      fieldBinding: "{value}"
                  ...
                  elementLabel: "Referral_Outcome_select",
                  userUpdatedElementLabel: true,
                  styleObjects: [
                    {
                      key: 0,
                  ...
                  key: "element_element_block_0_0_baseInputElement_3_0",
                  parentElementKey: "element_block_0_0"
                },
                {
                  key: "element_element_block_0_0_customLwc_4_0",
                  name: "Custom LWC",
                  element: "customLwc",
                  size: { isResponsive: false, default: "12" },
                  stateIndex: 0,
                  ...
                  property: {
                    ...
                    customLwcData: {
                      ...
                      IsExposed: true,
                      Id: "0RbBm0000003g7ZKAQ",
                      NamespacePrefix: "omnistudio",
                      ManageableState: "installed",
                      DeveloperName: "accordion"
                    }
                  },
                  type: "element",
                  styleObject: { sizeClass: "slds-size_12-of-12" },
                  parentElementKey: "element_block_0_0",
                  elementLabel: "Block-0-Custom LWC-4"
                },
                {
                  name: "Text",
                  element: "outputField",
                  ...
                  property: {
                    record: "{record}",
                    mergeField:
                      "%3Cdiv%3E%3Cspan%20style=%22color:%20#7e8c8d;%22%3ELast%20Modified%20By%20Peter%20Charalambous,%2012/12/2023%2012:12%20PM%3C/span%3E%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                    ...
                    inlineStyle: "",
                    class: "slds-text-align_right slds-p-bottom_x-small ",
                    style: "      \n         "
                  },
                ...
                },
                {
                  ...
                  children: [
                    {
                      key: "element_element_block_7_0_block_0_0",
                      name: "Block",
                      element: "block",
                      ...
                      children: [],
                      parentElementKey: "element_block_7_0",
                      elementLabel: "Block-7-Block-0"
                    },
                    {
                      name: "Action",
                      element: "action",
                      ...
                      userUpdatedElementLabel: true,
                      key: "element_element_block_7_0_action_1_0",
                      parentElementKey: "element_block_7_0",
                      styleObjects: [
                        {
                          key: 0,
                    ...
                    },
                    {
                      ...
                      userUpdatedElementLabel: true,
                      key: "element_element_block_7_0_action_2_0",
                      parentElementKey: "element_block_7_0"
                    }
                  ],
  ...
  title: "CreditAssessmentModal",
  enableLwc: true,
  isFlex: true,
  theme: "slds",
  selectableMode: "Multi",
  lwc: {
    DeveloperName: "cfCreditAssessmentModal_1_ANZx",
    Id: "0RbBm0000005byDKAQ",
    MasterLabel: "cfCreditAssessmentModal_1_ANZx",
    NamespacePrefix: "c",
    ManageableState: "unmanaged"
  },
  globalCSS: false,
  isRepeatable: false,
  Name: "CreditAssessmentModal",
  uniqueKey: "CreditAssessmentModal_1_ANZx",
  Id: "0koBm0000000ROPIA2",
  OmniUiCardKey: "CreditAssessmentModal/ANZx/1.0",
