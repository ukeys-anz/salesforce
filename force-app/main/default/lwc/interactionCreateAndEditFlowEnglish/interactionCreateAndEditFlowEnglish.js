...
import {
  ...
  setConnection,
  getConnection
} from "omnistudio/omniscriptRestApi";
import { RUN_MODES, registerNs } from "omnistudio/omniscriptInternalUtils";
import { OMNIDEF } from "./interactionCreateAndEditFlowEnglish_def.js";
import tmpl from "./interactionCreateAndEditFlowEnglish.html";
import tmpl_nds from "./interactionCreateAndEditFlowEnglish_nds.html";

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class interactionCreateAndEditFlowEnglish extends OmniscriptHeader {
  @track jsonDef = {};
  @track resume = false;
  @api get inline() {
    return this._inline;
    ...
    if (!isOffPlatform()) {
      ...
      const connectionVerificationCallback = () => {
        ...
        if (!hasConnection && elapsed < 60)
          // Timeout of 1 minute
          return this.waitForConnection(500).then(
      ...
      this.dispatchEvent(
        new CustomEvent("omnioutcomponentready", {
          bubbles: true,
          composed: true,
          detail: { omnioutcomponent: true }
        })
      );
