...
const imtDisputesFieldsMapping = {
  ...
  Payment_ID__c: "imt_anyone.puid",
  Receipt__c: "imt_anyone.payment_reference"
};
...
// Added transactionMadeBy in order to prepopulate the Case Dispute Form
...
function setBPAYDisputeSpecificFields(
  ...
  let address = addressBuilder("", personAccount.BillingStreet);
