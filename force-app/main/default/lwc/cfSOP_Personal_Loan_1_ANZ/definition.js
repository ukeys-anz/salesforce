          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3EInsititution%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3EMacquire%20Bank%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3E15%20years%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3E1500%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3Etest1233%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
