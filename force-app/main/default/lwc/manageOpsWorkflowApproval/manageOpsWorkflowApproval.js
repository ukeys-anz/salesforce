...
export default class ManageOpsWorkflowApproval extends LightningModal {
  ...
  approveRecord() {
    ...
    if (this.onboardingWorkflow) {
      this.updateCaseStatusOnboarding(requestedDataAPI);
    } else {
      this.updateCaseStatusPinAndSelfie(requestedDataAPI);
    }
  }

  updateCaseStatusPinAndSelfie(requestedDataAPI) {
    updateCaseStatusPinAndSelfie({
      idValue: this.options.IdValue,
      manageOpsRequest: requestedDataAPI,
  ...
  updateCaseStatusOnboarding(requestedDataAPI) {
    let requestedData = {
      idValue: this.options?.IdValue,
