let definition = {
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3EOverdraft%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField: "%3Cdiv%3EOverdraft%20Limit%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
  ...
  requiredPermission: "",
  lwc: {
    DeveloperName: "cfSOP_Line_of_Credit_1_ANZ",
    Id: "0Rb8s000000XtQjCAK",
    MasterLabel: "cfSOP_Line_of_Credit_1_ANZ",
    NamespacePrefix: "c",
    ManageableState: "unmanaged"
  },
  Id: "0ko8s0000000FQTAA2",
  OmniUiCardKey: "SOP_Line_of_Credit/ANZ/1.0",
