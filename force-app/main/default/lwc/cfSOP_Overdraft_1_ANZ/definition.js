let definition = {
              ...
              children: [
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField:
                      "%3Cdiv%3E$%7BinstitutionalLiability.limitAmount.value%7D%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField:
                      "%3Cdiv%3E$%7BoutstandingBalance.value%7D%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
                ...
                },
                {
                  ...
                  property: {
                    record: "{record}",
                    mergeField:
                      "%3Cdiv%3E%7BinstitutionalLiability.interestRate%7D%3C/div%3E",
                    card: "{card}"
                  },
                  type: "text",
                  styleObject: {
  ...
  requiredPermission: "",
  lwc: {
    DeveloperName: "cfSOP_Overdraft_1_ANZ",
    Id: "0Rb8s000000XXQDCA4",
    MasterLabel: "cfSOP_Overdraft_1_ANZ",
    NamespacePrefix: "c",
    ManageableState: "unmanaged"
  },
  Id: "0ko8s0000000FOrAAM",
  OmniUiCardKey: "SOP_Overdraft/ANZ/1.0",
