...
const creatingReportJsonFile = (targetOrg, runAllTestPackage) => {
  const runAllTestsReport = runAllLocalTests(targetOrg, runAllTestPackage);
...
const runTestReport = (whichJob) =>
  whichJob === "createJson"
    ? creatingReportJsonFile(TARGET_ORG, RUN_ALL_TEST_CLASS_PATH)
